    ...
    <div>
      <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl ">
          <div class="grid md:grid-cols-[2fr_repeat(3,_1fr)] md:grid-rows-1 gap-x-2 gap-y-1.25 px-4 py-6 lg:py-8 grid-cols-1 grid-rows-3 gap-0">
            {/* {Company} */}
            <div>
            ...
            <div className="">
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium ">
                <li class="mb-4 flex flex-row ">
                  <img
                    src="https://counter6.optistats.ovh/private/freecounterstat.php?c=jdrn1xhx7kuzef5h63brc1hrxa486pap"
                    border="0"
          ...
          <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
              © 2025 <a href="/">V+ Enterprises</a>. All Rights Reserved.
            </span>
